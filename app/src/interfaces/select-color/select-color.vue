...
.color-data-inputs .color-data-input:first-child {
	--g-border-radius: 4px 0px 0px 4px;
}

.color-data-inputs .color-data-input:last-child {
	--g-border-radius: 0px 4px 4px 0px;
}
